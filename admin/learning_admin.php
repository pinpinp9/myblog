...
if(isset($_POST['cancel'])){
 ...
 $sql = "INSERT INTO learning (en_topic,ch_topic,th_topic,en_desc,ch_desc,th_desc,`image`,writer
 ...
 $insert_content = mysqli_query($conn,$sql);
  if($insert_content){
      ...
      echo "<script> window.open('admin.php?insert_learning','_self') </script>"; 
...
<body>  
  <form class="form" action="learning_admin.php" method="post">
  <div class="wrapper">
  ...
  <h3> Learning English Version </h3>
  ...
  <h3> Learning Chinese Version </h3>
  <h4>Topic:
