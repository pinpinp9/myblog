...
if(isset($_POST['cancel'])){
 ...
 $sql = "INSERT INTO travel (en_topic,ch_topic,th_topic,en_desc,ch_desc,th_desc,`image`,writer
 ...
 $insert_content = mysqli_query($conn,$sql);
  if($insert_content){
      ...
      echo "<script> window.open('admin.php?insert_travel','_self') </script>"; 
...
<head>
    ...
    <title>Learning admin area</title>
    <style>
    *{
        padding:0;
        margin:0;
...
<body>  
  <form class="form" action="travel_admin.php" method="post" enctype='multipart/form-data' >
  <div class="wrapper">
